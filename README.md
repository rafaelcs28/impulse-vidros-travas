...
- A **identificação da versão do carro**: código de configuração, nível de acabamento, plataforma,
  tipo de motor e projeto. O **chassi fica de fora de propósito** — para comparar versões ele não
  acrescenta nada.
...
4. Deixe o aplicativo aberto e faça o teste: entrar no carro, destrancar, abrir um vidro, sair e
   trancar. Se puder, repita duas ou três vezes.
5. O botão **Compartilhar captura** envia o arquivo completo por onde você preferir.
...
odômetro) e a identificação da versão do veículo. Não tem chassi, não tem localização, não tem dado
de conta ou de telefone.
